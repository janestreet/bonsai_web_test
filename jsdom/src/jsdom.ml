...
|}
  ...
  let reset_global_state_for_startup ?(here = Stdlib.Lexing.dummy_pos) ?has_focus () =
...
module Handle_experimental = struct
  ...
  let create
    ...
    ~get_vdom
    (computation : Bonsai.graph -> a Bonsai.t)
    =
  ...
  let focus ?(here = Stdlib.Lexing.dummy_pos) harness ~selector =
    let node = query_selector_non_inert_exn ~here harness ~selector in
    node##focus
  ;;

  let blur ?(here = Stdlib.Lexing.dummy_pos) (_ : _ t) =
  ...
  (** This method fires click and associated events for the primary button
      ...
      it should be fine. *)
  let click_on ?(here = Stdlib.Lexing.dummy_pos) harness ~selector =
    let node = query_selector_non_inert_exn ~here harness ~selector in
  ...
  let right_click_on ?(here = Stdlib.Lexing.dummy_pos) harness ~selector =
    let node = query_selector_non_inert_exn ~here harness ~selector in
  ...
  let middle_click_on ?(here = Stdlib.Lexing.dummy_pos) harness ~selector =
    let node = query_selector_non_inert_exn ~here harness ~selector in
  ...
  let set_input_element_value ?(here = Stdlib.Lexing.dummy_pos) harness ~selector ~value =
    let node = query_selector_non_inert_exn ~here harness ~selector in
  ...
  *)
  ...
  let hover ?(here = Stdlib.Lexing.dummy_pos) harness ~selector =
    let node = query_selector_non_inert_exn ~here harness ~selector in
  ...
  let unhover ?(here = Stdlib.Lexing.dummy_pos) harness =
  ...
  let query_selector_exn ?(here = Stdlib.Lexing.dummy_pos) t ~selector =
