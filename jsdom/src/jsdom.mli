...
module Handle_experimental : sig
  ...
  val focus : ?here:Stdlib.Lexing.position -> _ t -> selector:string -> unit
  val blur : ?here:Stdlib.Lexing.position -> _ t -> unit
  val click_on : ?here:Stdlib.Lexing.position -> _ t -> selector:string -> unit
  val right_click_on : ?here:Stdlib.Lexing.position -> _ t -> selector:string -> unit
  val middle_click_on : ?here:Stdlib.Lexing.position -> _ t -> selector:string -> unit
  ...
  val hover : ?here:Stdlib.Lexing.position -> _ t -> selector:string -> unit

  (** See the [hover] doc comment for background on limitations. *)
  val unhover : ?here:Stdlib.Lexing.position -> _ t -> unit
